    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          <button
            onClick={onAllow}
            className="focus-ring flex-1 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium"
          >
            {t("notifications.modal.allow")}
          </button>
          <button
            onClick={onDismiss}
            className="focus-ring flex-1 px-4 py-2 bg-neutral-700 text-neutral-200 rounded-md hover:bg-neutral-600 transition-colors font-medium"
          >
