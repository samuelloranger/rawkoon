 ...
 * router (mixed read/write). Returns a 401/403 `Response` to return early, or
 * null when the user is an admin and the handler should proceed.
 *
 * Kept free of DB/auth imports so it can be unit-tested in isolation without
 * pulling the better-auth/Prisma import chain.
 */
